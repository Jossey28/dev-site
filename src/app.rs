...
fn Create88x31Row() -> impl IntoView {
    let mut eights: Vec<EightyEightData> = vec![
        EightyEightData::new(
            ...
            "https://github.com/Jossey28/dev-site",
            None,
        ),
        ...
        EightyEightData::new(
            "xbox_live-88x31.gif",
            "https://xenia-emulator.com/xbox-360-roms/",
            None,
        ),
        EightyEightData::new(
            "xbox_live-88x31.gif",
        ...
        EightyEightData::new(
            "stop_sign-88x31.gif",
            "https://matdoes.dev/buttons#d0f3c00fbd84b58dd3ab3cc353fc3ffd",
            None,
        ),
        EightyEightData::new(
        ...
        EightyEightData::new(
            ...
            "https://dev-site.homecamp.biz",
            None,
        ),
        EightyEightData::new(
            "steam_powered-88x31.gif",
            "https://web.archive.org/web/20041115052057/http://steampowered.com/",
            None,
        ),
        EightyEightData::new(
            "kitrinos-88x31.gif",
            "https://kitrinos.neocities.org/",
            None,
        ),
        EightyEightData::new(
